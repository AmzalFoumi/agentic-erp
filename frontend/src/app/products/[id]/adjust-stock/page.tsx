...
import { AdjustStockForm } from "./_components/adjust-stock-form";
...
export default async function AdjustStockPage({
  ...
  return (
    <div>
      <h1 className="mb-1 text-lg font-semibold">Adjust stock</h1>
      <div className="mb-section text-sm text-muted-foreground">
        {product.name} · {product.sku}
      </div>
      <AdjustStockForm id={product.id} currentQuantity={product.quantity_on_hand} />
    </div>
  );
}
